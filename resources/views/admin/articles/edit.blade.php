        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        {!! Form::model($article, ['route' => ['articles.update', $article->id], 'role'=>"form", 'method' => 'PATCH', 'enctype'=>'multipart/form-data']) !!}
                        @include('admin.articles._form', ['submitButton' => '<i class="fa fa-edit"></i> Edit'])
                        {!! Form::close() !!}
